...
const services = [
  {
    ...
    subtitle: "Ending waste mismanagement through high-clarity spatial intelligence",
    description:
    ...
    accentLight: "#CCFBF1",
    points: [
      "Detection of illegal dumping hotspots & encroachment",
      "Landfill expansion & volumetric height monitoring",
      "3D waste volume & cut-fill capacity estimation",
      "Tamper-proof GIS evidence for municipal enforcement",
    ],
    tags: [
      "Landfill Planning",
      "Reduced Flooding",
  ...
  {
    id: "stubble-burning",
    title: "Stubble Burning Monitoring",
    subtitle: "Enabling Clean Air and Sustainable Farming Through Geospatial Intelligence",
    description:
    ...
    accentLight: "#FFEDD5",
    points: [
      "Near-real-time identification of stubble burning incidents",
      "Evidence-based compliance & farmer advisory support",
      "Targeted air pollution & seasonal smog interventions",
      "Climate action, residue mapping & emission reporting",
    ],
    tags: [
      "Clean Air",
      "Soil Health",
...
export default function EnvironmentalConservationDetail({ handleBack, setActiveTab }) {
    ...
    >
      ...
      <div
        style={{
          ...
          backgroundImage: `url('/environmentalconversation.png')`,
      ...
      >
        ...
        >
          ...
          <div>
            ...
            >
              Thermal and optical surveillance to track landfill expansion, detect
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '14px', flexWrap: 'wrap' }}>
              ...
              <a
                href="https://wa.me/917985791210?text=Hello%20TerrAqua%20UAV%20Team,%20I%20would%20like%20to%20inquire%20about%20a%20project%20for%20Environmental%20Conservation."
                target="_blank"
      ...
      >
        ...
        >
          ...
          >
            ...
            <span style={{ color: 'var(--color-orange)', fontWeight: 400 }}>Environmental Conservation</span>?
          </h3>
          ...
          >
            Our team of certified drone pilots, environmental analysts, and remote sensing
            engineers is ready to execute compliance audits and aerial surveillance missions anywhere across the country.
          </p>
          ...
          >
            <a
              href="https://wa.me/917985791210?text=Hello%20TerrAqua%20UAV%20Team,%20I%20would%20like%20to%20connect%20with%20your%20GIS%20Experts%20for%20Environmental%20Conservation."
              target="_blank"
              rel="noopener noreferrer"
              style={{
                padding: '13px 32px',
