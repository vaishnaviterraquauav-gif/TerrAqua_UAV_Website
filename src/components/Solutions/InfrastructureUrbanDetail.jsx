...
const services = [
  {
    id: "land-digitization",
    title: "Land Digitization",
    subtitle: "Transforming land records into accurate, accessible digital assets",
    description:
    ...
    accentLight: "#E0F2FE",
    points: [
      "Centimeter-level boundary & parcel accuracy",
      "Digital land parcel & ownership mapping",
      "Encroachment & land-use change detection",
      "GIS-ready layers for municipal e-governance platforms",
    ],
    tags: [
  ...
  },
  {
    id: "digital-twin",
    title: "Digital Twin",
    subtitle: "Creating intelligent virtual replicas to manage real-world assets",
    description:
    ...
    accentLight: "#EDE9FE",
    points: [
      "Sub-centimeter terrain & structural geometry",
      "Real-time sensor, IoT & imagery integration",
      "Lifecycle infrastructure change detection",
      "Interactive 3D visualization for all stakeholders",
    ],
    tags: [
      "Asset Visibility",
      "Predictive Tech",
  ...
  },
  {
    id: "3d-modelling",
    title: "3D Modelling",
    subtitle: "Building lifelike 3D environments for planning & engineering",
    description:
    ...
    accentLight: "#CCFBF1",
    points: [
      "Rich spatial context & elevation for BIM design",
      "Accurate cut-and-fill volume & height metrics",
      "Photorealistic reality mesh & digital site replicas",
      "Precise modelling of complex urban terrain",
    ],
    tags: [
      "Site Analysis",
      "Better Visuals",
  ...
  },
  {
    ...
    subtitle: "Optimizing solar energy performance with thermal intelligence",
    description:
    ...
    accentLight: "#FFEDD5",
    points: [
      "Rapid aerial scanning of tens of thousands of panels",
      "High-resolution radiometric thermal hotspot detection",
      "AI-based string, diode & micro-crack defect classification",
      "Geotagged maintenance-ready O&M audit reports",
    ],
    tags: [
...
export default function InfrastructureUrbanDetail({ handleBack, setActiveTab }) {
      ...
      >
        ...
        <div
          style={{
            position: 'absolute',
            inset: 0,
            background: 'linear-gradient(180deg, rgba(0,0,0,0.42) 0%, rgba(0,0,0,0.64) 100%)'
          }}
        />
      ...
      >
        ...
        >
          ...
          <div>
            ...
            >
              LiDAR and photogrammetry scanning to modernize land records, build
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '14px', flexWrap: 'wrap' }}>
              ...
              <a
                href="https://wa.me/917985791210?text=Hello%20TerrAqua%20UAV%20Team,%20I%20would%20like%20to%20inquire%20about%20a%20project%20for%20Infrastructure%20and%20Urban%20Planning."
                target="_blank"
      ...
      >
        ...
        >
          ...
          >
            ...
            <span style={{ color: 'var(--color-orange)', fontWeight: 400 }}>Infrastructure & Urban Planning</span>?
          </h3>
          ...
          >
            Our certified drone pilots, GIS analysts, and BIM engineers are ready
            to execute LiDAR corridor surveys, reality mesh modeling, and thermal inspections anywhere across the country.
          </p>
          ...
          >
            <a
              href="https://wa.me/917985791210?text=Hello%20TerrAqua%20UAV%20Team,%20I%20would%20like%20to%20connect%20with%20your%20GIS%20Experts%20for%20Infrastructure%20and%20Urban%20Planning."
              target="_blank"
              rel="noopener noreferrer"
              style={{
                padding: '13px 32px',
