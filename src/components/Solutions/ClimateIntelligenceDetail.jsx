...
const services = [
  {
    ...
    subtitle: "Empowering climate action with data-driven carbon insights",
    description:
    ...
    accentLight: "#DCFCE7",
    points: [
      "Landscape-level carbon stock estimation",
      "Time-series carbon gain/loss tracking",
      "Canopy height & vegetative biomass mapping",
      "Automated baseline generation for carbon credits",
    ],
    tags: [
      "ESG & CSR Ready",
      "Lower Audit Costs",
  ...
  },
  {
    ...
    subtitle: "Science-backed carbon stock and carbon-change assessments",
    description:
    ...
    accentLight: "#CCFBF1",
    points: [
      "MRV-ready scalable atmospheric monitoring",
      "Biomass density & CO2 flux modelling",
      "Automated baseline methodologies",
      "Global standard compliance (Verra / Gold Standard)",
    ],
    tags: [
      "Climate Compliance",
...
const capabilities = [
  ...
  "Credit Verification AI",
  "Net Zero Forecasting",
]
...
export default function ClimateIntelligenceDetail({ handleBack, setActiveTab }) {
        ...
        >
          ...
          <div>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '14px', flexWrap: 'wrap' }}>
              ...
              <a
                href="https://wa.me/917985791210?text=Hello%20TerrAqua%20UAV%20Team,%20I%20would%20like%20to%20inquire%20about%20a%20project%20for%20Climate%20Intelligence%20and%20Thermal%20GIS."
                target="_blank"
      ...
      >
        ...
        >
          ...
          >
            ...
            <span style={{ color: 'var(--color-orange)', fontWeight: 400 }}>Climate Intelligence</span>?
          </h3>
          ...
          >
            Our certified drone pilots, climate modelers, and GIS engineers are ready
            to execute carbon stock audits, microclimate assessments, and emission tracking anywhere across the country.
          </p>
          ...
          >
            <a
              href="https://wa.me/917985791210?text=Hello%20TerrAqua%20UAV%20Team,%20I%20would%20like%20to%20connect%20with%20your%20GIS%20Experts%20for%20Climate%20Intelligence."
              target="_blank"
              rel="noopener noreferrer"
              style={{
                padding: '13px 32px',
