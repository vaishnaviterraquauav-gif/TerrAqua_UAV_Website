...
const services = [
  {
    ...
    subtitle: "Bringing invisible crop stress to light with geospatial analytics",
    description:
    ...
    accentLight: "#DCFCE7",
    points: [
      "Early detection of nutrient & pest stress",
      "Multispectral crop health indicators (NDVI / NDRE)",
      "Growth comparison across plots & micro-zones",
      "Actionable insights for targeted variable-rate spraying",
    ],
    tags: [
      "Reduce Crop Loss",
      "Higher Yields",
  ...
  },
  {
    ...
    subtitle: "Delivering the right water to the right place at the right time",
    description:
    ...
    accentLight: "#E0F2FE",
    points: [
      "Accurate soil moisture & drainage insights",
      "Plant-level water stress & canopy temperature detection",
      "ET-based crop water requirement estimates",
      "Heat stress mapping with high-resolution thermal intensity",
    ],
    tags: [
      "Reduced Waste",
      "Lower Costs",
  ...
  },
  {
    ...
    subtitle: "Predicting harvest outcomes with scientific accuracy",
    description:
    ...
    accentLight: "#FEF3C7",
    points: [
      "Landscape-scale crop stand count & vigor assessment",
      "Time-series growth trend & canopy height monitoring",
      "Biomass & vegetative reflectance correlation",
      "Object-based ML yield prediction models",
    ],
    tags: [
      "Smart Procurement",
      "Insurance Accuracy",
  ...
  },
  {
    ...
    subtitle: "Precision biomass intelligence for agriculture & climate monitoring",
    description:
    ...
    accentLight: "#CCFBF1",
    points: [
      "Scalable regional vegetative quantification",
      "Drone-based canopy volume & 3D point cloud modelling",
      "Satellite index–driven biomass estimation",
      "Time-series biomass accumulation tracking",
    ],
    tags: [
      "Fertilizer Planning",
      "Carbon Reporting",
...
export default function AgricultureDetail({ handleBack, setActiveTab }) {
      ...
      >
        ...
        >
          ...
          <div>
            ...
            >
              Empowering modern agribusinesses with multispectral drone surveys,
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '14px', flexWrap: 'wrap' }}>
              ...
              <a
                href="https://wa.me/917985791210?text=Hello%20TerrAqua%20UAV%20Team,%20I%20would%20like%20to%20inquire%20about%20a%20project%20for%20Agriculture%20and%20Precision%20Farming."
                target="_blank"
      ...
      >
        ...
        >
          ...
          >
            ...
            <span style={{ color: 'var(--color-orange)', fontWeight: 400 }}>Agriculture</span>?
          </h3>
          ...
          >
            Our team of certified drone pilots, agronomists, and GIS engineers is ready
            to execute multispectral aerial surveys and precision spraying anywhere across the country.
          </p>
          ...
          >
            <a
              href="https://wa.me/917985791210?text=Hello%20TerrAqua%20UAV%20Team,%20I%20would%20like%20to%20connect%20with%20your%20GIS%20Experts%20for%20Precision%20Agriculture."
              target="_blank"
              rel="noopener noreferrer"
              style={{
                padding: '13px 32px',
