...
$filePath = "C:\Users\Admin\Downloads\TerrAqua_Website\public\image copy.png"
$outPath = "C:\Users\Admin\Downloads\TerrAqua_Website\public\startupindia-clean.png"
...
$newBmp.Dispose()
Write-Host "Successfully converted image copy.png to startupindia-clean.png with transparent background"
